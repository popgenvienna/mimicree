...
parser.add_option("--snp-count",dest="snpcount",help="The number of SNPs which should be randomly drawn")
...
entries=SumReader.parseLines(File.randomly_draw_lines(options.sum,int(options.snpcount)))
